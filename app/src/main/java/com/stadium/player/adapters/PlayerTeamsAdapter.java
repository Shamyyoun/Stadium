 ...
 */
public class PlayerTeamsAdapter extends ParentRecyclerAdapter<PlayerTeams> {

    public PlayerTeamsAdapter(Context context, List<PlayerTeams> data, int layoutId) {
    ...
    public void onBindViewHolder(ParentRecyclerViewHolder viewHolder, final int position) {
        ...
        // set data
        final PlayerTeams item = data.get(position);
