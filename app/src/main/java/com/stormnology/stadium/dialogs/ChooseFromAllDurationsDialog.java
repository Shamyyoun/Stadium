 ...
 */
public class ChooseFromAllDurationsDialog extends ProgressDialog {
    ...
    public ChooseFromAllDurationsDialog(final Context context) {
        super(context);
        setTitle(R.string.all_times);
    ...
    private void updateUI() {
        ...
        data = durationController.addDefaultItem(data, getString(R.string.all_times));
    ...
    public void onSuccess(Object response, int statusCode, String tag) {
        // get data
        String[] durationsArr = (String[]) response;
        data = durationController.createList(durationsArr);
    ...
    private void selectCheckedItem() {
        int itemPosition = durationController.getItemPosition(data, selectedTimeStart, selectedTimeEnd);
        if (itemPosition != -1) {
