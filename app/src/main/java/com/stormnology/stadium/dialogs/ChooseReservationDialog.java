 ...
 */
public class ChooseReservationDialog extends ProgressDialog {
    private int teamId;
    ...
    public ChooseReservationDialog(final Context context, int teamId) {
        super(context);
    ...
    protected int getContentViewResId() {
        return R.layout.dialog_choose_reservation;
    }
    ...
    private void loadData() {
        ...
        // send request
        ConnectionHandler connectionHandler = ApiRequests.challengeReservations(context, this, teamId);
    ...
    private void selectCheckedItem() {
        ...
        int itemPosition = reservationController.getItemPosition(data, selectedItemId);
        if (itemPosition != -1) {
